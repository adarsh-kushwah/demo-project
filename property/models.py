...
class Property(models.Model):
    ...
    def save(self, *args, **kwargs):
        """
            ...
            if booking not confirmed by renter
        """
        status_choice = PropertyRequestResponse.STATUS_CHOICES
        property_request_response = PropertyRequestResponse.objects.filter(status=status_choice[1][0], request_response_property=self, user__user_type='owner')
